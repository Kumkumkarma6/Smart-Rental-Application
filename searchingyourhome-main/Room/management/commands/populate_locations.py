...
from Room.models import State, District

class Command(BaseCommand):
    help = 'Populate Indian states and districts'
    ...
    def handle(self, *args, **options):
        ...
        states_districts = {
            ...
            "Arunachal Pradesh": [
                "Anjaw", "Changlang", "Dibang Valley", "East Kameng", "East Siang", "Kra Daadi", "Kurung Kumey", "Lepa Rada", "Lohit", "Longding", "Lower Dibang Valley", "Lower Subansiri", "Namsai", "Pakke Kessang", "Papum Pare", "Shi Yomi", "Siang", "Tawang", "Tirap", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang"
            ],
            "Assam": [
            ...
            "Punjab": [
                "Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka", "Ferozepur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", "Mansa", "Moga", "Muktsar", "Nawanshahr", "Pathankot", "Patiala", "Rupnagar", "Sahibzada Ajit Singh Nagar", "Sangrur", "Sri Muktsar Sahib", "Tarn Taran"
            ],
            "Rajasthan": [
        ...
        for state_name, districts in states_districts.items():
            ...
            for district_name in districts:
                District.objects.get_or_create(state=state, dist=district_name)

        self.stdout.write(self.style.SUCCESS('All Indian states and districts have been added successfully.'))